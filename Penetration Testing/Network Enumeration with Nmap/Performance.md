...
```shell-session
0xscary@htb[/htb]$ sudo nmap 10.129.2.0/24 -F
...
```shell-session
0xscary@htb[/htb]$ sudo nmap 10.129.2.0/24 -F --initial-rtt-timeout 50ms --max-rtt-timeout 100ms
...
```shell-session
0xscary@htb[/htb]$ sudo nmap 10.129.2.0/24 -F | grep "/tcp" | wc -l
...
```shell-session
0xscary@htb[/htb]$ sudo nmap 10.129.2.0/24 -F --max-retries 0 | grep "/tcp" | wc -l
...
```shell-session
0xscary@htb[/htb]$ sudo nmap 10.129.2.0/24 -F -oN tnet.default
...
```shell-session
0xscary@htb[/htb]$ sudo nmap 10.129.2.0/24 -F -oN tnet.minrate300 --min-rate 300
